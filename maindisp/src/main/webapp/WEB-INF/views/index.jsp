            ...
            <div class="main-header header-sticky">
                <div class="container-fluid">
                    <div class="menu-wrapper d-flex align-items-center justify-content-between">
                        <!-- Logo -->
                        <div class="logo">
                            <a href="index"><img src="${pageContext.request.contextPath}/resources/assets/img/logo/logo.png" alt="logo" width="80" height="50"></a>
                        </div>
                        <!-- Main-menu -->
                        <div class="main-menu f-right d-none d-lg-block">
                            <nav>
                                <ul id="navigation">
                                    ...
                                    <li><a href="listing.html">Bus</a></li> 
                                    <li><a href="#">Hotel</a>
                                        <ul class="submenu">
                                    ...
                                    <li><a href="blog.html">Restaurant</a>
                                        <ul class="submenu">
                                    ...
                                    <li><a href="board_list.do">Forum</a></li>
                                </ul>
                            </nav>
                        </div>          
                        <!-- Header-btn -->
                        ...
                        <ul>
                            ...
                            <li><a href="#" class="mr-40"><i class="ti-user"></i></a>
                            	<ul class="submenu">
                               		<li><a href="blog.html">My Page</a></li>
                              		<li><a href="blog_details.html">Sign Up</a></li>
                            	</ul>
                            </li>
                        </ul>
                        </div>
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-lg-6 col-md-6 col-sm-6">
                        <div class="single-location mb-30">
                            <div class="location-img">
                                <img src="${pageContext.request.contextPath}/resources/assets/img/gallery/location1.png" alt="">
                            </div>
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-6">
                        <div class="single-location mb-30">
                            <div class="location-img">
                                <img src="${pageContext.request.contextPath}/resources/assets/img/gallery/location2.png" alt="">
                            </div>
                            <div class="location-details">
                                <p>Paris</p>
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-6">
                        <div class="single-location mb-30">
                            <div class="location-img">
                                <img src="${pageContext.request.contextPath}/resources/assets/img/gallery/location3.png" alt="">
                            </div>
                            <div class="location-details">
                                <p>Rome</p>
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-6">
                        <div class="single-location mb-30">
                            <div class="location-img">
                                <img src="${pageContext.request.contextPath}/resources/assets/img/gallery/location4.png" alt="">
                            </div>
                            <div class="location-details">
                                <p>Italy</p>
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-6">
                        <div class="single-location mb-30">
                            <div class="location-img">
                                <img src="${pageContext.request.contextPath}/resources/assets/img/gallery/location5.png" alt="">
                            </div>
                            <div class="location-details">
                                <p>Nepal</p>
            ...
            <div class="container">
                ...
                <div class="directory-active">
                    ...
                    <div class="properties pb-20">
                        <div class="properties__card">
                            <div class="properties__img overlay1">
                                <a href="#"><img src="${pageContext.request.contextPath}/resources/assets/img/gallery/properties1.png" alt=""></a>
                                <div class="img-text">
                                    <span>$$$</span>
                                    <span>Closed</span>
                                </div>
                                <div class="icon">
                                    <img src="${pageContext.request.contextPath}/resources/assets/img/gallery/categori_icon1.png" alt=""> 
                                </div>
                            </div>
                            ...
                            <div class="properties__footer d-flex justify-content-between align-items-center">
                                <div class="restaurant-name">
                                    <img src="${pageContext.request.contextPath}/resources/assets/img/gallery/restaurant-icon.png" alt="">
                                    <h3>Food & Restaurant</h3>
                                </div>
                                <div class="heart">
                                    <img src="${pageContext.request.contextPath}/resources/assets/img/gallery/heart1.png" alt="">
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="properties pb-20">
                        <div class="properties__card">
                            <div class="properties__img overlay1">
                                <a href="#"><img src="${pageContext.request.contextPath}/resources/assets/img/gallery/properties2.png" alt=""></a>
                                <div class="img-text">
                                    <span>$$$</span>
                                    <span>Closed</span>
                                </div>
                    ...
                    <div class="properties pb-20">
                        <div class="properties__card">
                            <div class="properties__img overlay1">
                                <a href="#"><img src="${pageContext.request.contextPath}/resources/assets/img/gallery/properties3.png" alt=""></a>
                                <div class="img-text">
                                    <span>$$$</span>
                                    <span>Closed</span>
                                </div>
            ...
            <div class="container">
                ...
                <div class="directory-active">
                    ...
                    <div class="properties pb-20">
                        <div class="properties__card">
                            <div class="properties__img overlay1">
                                <a href="#"><img src="${pageContext.request.contextPath}/resources/assets/img/gallery/newDirectory1.png" alt=""></a>
                                <div class="img-text">
                                    <span>$$$</span>
                                    <span>Closed</span>
                                </div>
                    ...
                    <div class="properties pb-20">
                        <div class="properties__card">
                            <div class="properties__img overlay1">
                                <a href="#"><img src="${pageContext.request.contextPath}/resources/assets/img/gallery/newDirectory2.png" alt=""></a>
                                <div class="img-text">
                                    <span>$$$</span>
                                    <span>Closed</span>
                                </div>
                    ...
                    <div class="properties pb-20">
                        <div class="properties__card">
                            <div class="properties__img overlay1">
                                <a href="#"><img src="${pageContext.request.contextPath}/resources/assets/img/gallery/newDirectory3.png" alt=""></a>
                                <div class="img-text">
                                    <span>$$$</span>
                                    <span>Closed</span>
                                </div>
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-lg-6 col-md-6 col-sm-12">
                        <div class="single-location mb-30">
                            <div class="location-img">
                                <img src="${pageContext.request.contextPath}/resources/assets/img/gallery/home-blog1.png" alt="">
                            </div>
                            <div class="location-details">
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-12">
                        <div class="single-location mb-30">
                            <div class="location-img">
                                <img src="${pageContext.request.contextPath}/resources/assets/img/gallery/home-blog2.png" alt="">
                            </div>
                            <div class="location-details">
                                <a href="#" class="location-btn">Tips</a>
                                <ul>
                ...
                <div class="wants-wrapper w-padding2">
                    <div class="row justify-content-between">
                        <div class="col-xl-8 col-lg-8 col-md-7">
                            <div class="wantToWork-caption wantToWork-caption2">
                                <img src="${pageContext.request.contextPath}/resources/assets/img/logo/logo2_footer.png" alt="" class="mb-20">
